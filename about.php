            ...
            <div class="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    <p class="text-gray-600 leading-relaxed">
                        <?= $text['about_company_text_1']; ?>
                    </p>

                    <p class="mt-4 text-gray-600 leading-relaxed">
                        <?= $text['about_company_text_2']; ?>
                    </p>

                    <a href="contact.php" class="inline-block mt-6 text-blue-900 font-semibold"><?= $text['about_contact_button']; ?> →</a>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="rounded-3xl border border-blue-100 bg-gradient-to-br from-blue-50 to-cyan-50 p-8 shadow-sm hover:shadow-lg transition">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900"><?= $text['about_vision_title']; ?></h3>
                    <p class="mt-4 text-gray-700 leading-relaxed font-bold">
                        <?= $text['about_vision_text']; ?>
                    </p>
                </div>
                ...
                <div class="rounded-3xl border border-gray-200 bg-white p-8 shadow-sm hover:shadow-lg transition">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900"><?= $text['about_mission_title']; ?></h3>
                    <ul class="mt-4 space-y-3 text-gray-700 leading-relaxed">
                        <li class="flex gap-3">
                            <span class="text-blue-700 mt-1">•</span>
                            <span><?= $text['about_mission_1']; ?></span>
                        </li>
                        <li class="flex gap-3">
                            <span class="text-blue-700 mt-1">•</span>
                            <span><?= $text['about_mission_2']; ?></span>
                        </li>
                        <li class="flex gap-3">
                            <span class="text-blue-700 mt-1">•</span>
                            <span><?= $text['about_mission_3']; ?></span>
                        </li>
                        <li class="flex gap-3">
                            <span class="text-blue-700 mt-1">•</span>
                            <span><?= $text['about_mission_4']; ?></span>
                        </li>
                        <li class="flex gap-3">
                            <span class="text-blue-700 mt-1">•</span>
                            <span><?= $text['about_mission_5']; ?></span>
                        </li>
                        <li class="flex gap-3">
                            <span class="text-blue-700 mt-1">•</span>
                            <span><?= $text['about_mission_6']; ?></span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="grid md:grid-cols-4 gap-3">
                ...
                <div class="bg-white rounded-2xl p-6 text-center shadow-lg">
                    ...
                    <button type="button"
                        ...
                        data-role="<?= $text['about_team_architect_role']; ?>"
                        data-certificate="assets/images/team/skk-igede.jpg"
                        data-certificate-skn="assets/images/team/skn-igede.jpg">
                        I Gede Suarjana S.T
                    </button>
                    <p class="text-blue-700 font-semibold mt-1"><?= $text['about_team_architect_role']; ?></p>
                    <p class="mt-3 text-gray-600 text-sm">
                        <?= $text['about_team_architect_description']; ?>
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 text-center shadow-lg">
                    ...
                    <button type="button"
                        ...
                        data-role="<?= $text['about_team_structure_role']; ?>"
                    ...
                    <p class="text-blue-700 font-semibold mt-1"><?= $text['about_team_structure_role']; ?></p>
                    <p class="mt-3 text-gray-600 text-sm">
                        <?= $text['about_team_structure_description']; ?>
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 text-center shadow-lg">
                    ...
                    <button type="button"
                        class="mt-6 text-xl font-bold text-gray-900 hover:text-blue-700 transition"
                        data-name="Fajar ST"
                        data-role="<?= $text['about_team_mep_role']; ?>"
                        data-certificate="assets/images/team/skk-fajar.jpg"
                        data-certificate-skn="assets/images/team/skn-fajar.jpg">
                        Fajar ST
                    </button>
                    <p class="text-blue-700 font-semibold mt-1"><?= $text['about_team_mep_role']; ?></p>
                    <p class="mt-3 text-gray-600 text-sm">
                        <?= $text['about_team_mep_description']; ?>
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-6 text-center shadow-lg">
                    ...
                    <button type="button"
                        class="mt-6 text-xl font-bold text-gray-900 hover:text-blue-700 transition"
                        data-name="Anis SE"
                        data-role="<?= $text['about_team_admin_role']; ?>"
                        data-certificate="assets/images/team/skk-anis.jpg"
                        data-certificate-skn="assets/images/team/skn-anis.jpg">
                        Anis SE
                    </button>
                    <p class="text-blue-700 font-semibold mt-1"><?= $text['about_team_admin_role']; ?></p>
                    <p class="mt-3 text-gray-600 text-sm">
                        <?= $text['about_team_admin_description']; ?>
                    </p>
                </div>
